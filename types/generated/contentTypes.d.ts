...
export interface ApiAlunoAluno extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    turma_id: Attribute.String;
    pagante: Attribute.Boolean;
...
export interface ApiCatracaCatraca extends Schema.CollectionType {
  collectionName: 'catraca';
  info: {
    singularName: 'catraca';
    pluralName: 'catracas';
    displayName: 'Catraca';
    description: '';
  };
